...
<li
    ...
    <a
        ...
        @php
        // Comprobamos si la etiqueta de este ítem es "Alertas"
        $isAlerts = trim((string) $slot) === 'Alertas';
        @endphp
        ...
        <x-filament::icon
            ...
            // --- ¡LA MAGIA! ---
            // Si es "Alertas", le añadimos la animación.
            'animate-bounce' => $isAlerts,
            ])
            />
            @endif
            ...
            <div
                ...
                @if (! $first)
                <div
                    class="absolute -top-1/2 bottom-1/2 w-px bg-gray-300 dark:bg-gray-600"></div>
                @endif

                @if (! $last)
                <div
                    class="absolute -bottom-1/2 top-1/2 w-px bg-gray-300 dark:bg-gray-600"></div>
                @endif
